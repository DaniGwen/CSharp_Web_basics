...
namespace SIS.MvcFramework
{
    public class Server
    {
        ...
        {
            CoreValidator.ThrowIfNull(this.serverRoutingTable, nameof(this.serverRoutingTable));
            CoreValidator.ThrowIfNull(this.httpSessionStorage, nameof(this.httpSessionStorage));
